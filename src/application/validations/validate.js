...
const validate = async (schema, body, async = false, { files = null, context = null } = {}) => {
	...
	const result = async ? await schema.validateAsync(data, schemaConfig) : schema.validate(data, schemaConfig);
